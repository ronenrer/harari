...
function bones_scripts_and_styles() {
	...
	if (!is_admin()) {
		...
		wp_register_script( 'bones-scroller', get_stylesheet_directory_uri() . '/library/js/min/jquery.mCustomScrollbar.concat.min.js', array( 'jquery' ), '', true );
		...
		*/
		...
		wp_enqueue_script( 'bones-scroller' );
